...
export const HeroSection: React.FC<HeroSectionProps> = ({ onStart }) => {
  ...
  return (
    <div className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 py-10 sm:py-16 z-10 select-none animate-fadeIn">
      ...
      {/* Hero Headline */}
      <h1 className={`font-display font-bold text-3xl sm:text-5xl lg:text-7xl text-ink max-w-4xl mx-auto leading-[1.15] sm:leading-[1.1] tracking-tight mb-5 sm:mb-6 ${language === "ta" ? "text-2xl sm:text-4xl lg:text-6xl leading-[1.38] sm:leading-[1.3]" : ""}`}>
        {language === "en" ? (
          <>
            Who are you{" "}
